...
class ProcessadorListView(LoginRequiredMixin, ListView):
    template_name = "processadores/processadores_list.html"
    model = Processador
...
class ProcessadorCreateView(LoginRequiredMixin,CreateView):
    template_name = "processadores/processadores_create.html"
...
class ProcessadorUpdateView(LoginRequiredMixin, UpdateView):
    template_name = "processadores/processadores_update.html"
    template_name_suffix = "_update"
    model = Processador
    fields = "__all__"

class ProcessadorDeleteView(DeleteView):
    template_name = 'processadores/processadores_confirm_delete.html'
    model = Processador
